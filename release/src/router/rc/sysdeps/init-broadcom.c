...
_dprintf("*** Multicast IPTV: config Singtel TR069 on wan port ***\n");
	...
	case MODEL_XT12:
		...
		else if (model == MODEL_RTAC86U || model == MODEL_RTAX88U || model == MODEL_BC109 || model == MODEL_EBG19 || model == MODEL_EBG15 || model == MODEL_EBP15 || model == MODEL_RTAX92U || model == MODEL_RTAX56U || model == MODEL_GTAX11000 || model == MODEL_RTAX86U || model == MODEL_RTAX68U || model == MODEL_RTAC68U_V4) {
		...
		if (nvram_match("switch_stb_x", "1") && nvram_match("switch_wantag", "none")) {
			...
			if (model == MODEL_RTAC86U || model == MODEL_RTAX88U || model == MODEL_BC109 || model == MODEL_EBG19 || model == MODEL_EBG15 || model == MODEL_EBP15 || model == MODEL_RTAX92U || model == MODEL_RTAX56U || model == MODEL_GTAX11000 || model == MODEL_RTAX86U || model == MODEL_RTAX68U || model == MODEL_RTAC68U_V4 || model == MODEL_GTAXE11000) {
				sprintf(ethPort1, "eth3");
				sprintf(vlanDev1, "eth3.v0");
				sprintf(ethPort2, "eth4");
				sprintf(vlanDev2, "eth4.v0");
